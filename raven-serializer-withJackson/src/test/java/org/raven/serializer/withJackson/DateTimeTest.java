...
public class DateTimeTest {
    ...
    public void test() throws IOException {
        ...
        res = "{\"Id\":0,\"Name\":null,\"Time\":null,\"List\":null,\"A\":0,\"Date2\":\"2019-06-28T20:10:11.907+0800\",\"Gender\":1}";
        user = serializer.deserialize(User.class, res.getBytes());
        System.out.println(user.toString());

        res = "{\"Id\":0,\"Name\":null,\"Time\":null,\"List\":null,\"A\":0,\"Date2\":\"2019-06-28 16:34:46.123\",\"Gender\":2}";
        user = serializer.deserialize(User.class, res.getBytes());
        System.out.println(user.toString());
